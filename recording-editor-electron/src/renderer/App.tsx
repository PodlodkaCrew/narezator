...
export default function Home(){
 ...
 useEffect(()=>{
  window.cutroom.workspaceInfo().then(async info=>{
   setWorkspaceInfo(info);if(!info.active)return;
   const recording=await window.cutroom.loadRecording();recording.words.sort((a,b)=>a.start-b.start||a.id-b.id);setData(recording);
